...
export function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className={`fixed right-5 bottom-5 z-40 flex size-14 items-center justify-center rounded-full bg-whatsapp text-white shadow-lg shadow-navy-950/20 transition-all duration-300 hover:bg-whatsapp-dark ${
